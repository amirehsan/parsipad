  ...
  "grammarPoints": [
    {
      ...
      "explanation": "Detailed explanation in target language (3-4 sentences)",
      "examples": [
        { "source": "example in source language", "target": "translation", "highlight": "key word/phrase to highlight" },
        { "source": "another example", "target": "its translation", "highlight": "key element" },
        { "source": "third example", "target": "its translation", "highlight": "key element" }
      ],
      "compareContrast": {
...
- Wrong options should be PLAUSIBLE alternatives that test subtle grammar distinctions:
  ...
  * Use words that are commonly confused by learners
...
- Provide exactly 3 examples per grammar point
