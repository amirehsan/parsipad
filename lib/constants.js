...
- American English spelling for English; standard written Persian for Persian.
- Always send all four keys.
- If no text is detected, return empty strings with "direction": "unknown" and "unsupported": false.
- If the visible text is neither Persian nor English, set "unsupported": true and leave the other three empty.
